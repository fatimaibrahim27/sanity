...
export const Twitter = ({ className = "", ...rest }: { className?: string }) => (
  <svg
...
export const Youtube = ({ className = "", ...props }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    xmlSpace="preserve"
...
export const Github = ({ className = "", ...rest }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 28 28"
    className={`${className}`}
...
export const Linkedin = ({ className = "", ...rest }: { className?: string }) => (
