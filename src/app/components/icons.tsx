...
const Twitter = ({ className = "", ...rest }: IconProps & React.SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      ...
      fill="#3ba9ee" // Removed the prop and hardcoded fill color
    />
  </svg>
);

const Youtube = ({ className = "", ...props }: IconProps & React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    xmlSpace="preserve"
  ...
  >
    <path
      ...
      fill="#f61c0d" // Removed the prop and hardcoded fill color
    />
  </svg>
);

const Github = ({ className = "", ...rest }: IconProps & React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 28 28"
    className={className}
  ...
  >
    <path
      ...
      fill="#000000" // Removed the prop and hardcoded fill color
    />
  </svg>
);

const Facebook = ({ className = "", ...rest }: IconProps & React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 32 32"
...
const Linkedin = ({ className = "", ...rest }: IconProps & React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 32 32"
    className={className}
